...
Manager.prototype.submitJob = function submitJob(jobid, data, opts, submitted_cb) {
    ...
    self.redis.eval(scripts.addJob, 7, 
                    this.queuekey, this.delayqueuekey, this.delayprioritieskey, this.livesetkey, this.activequeuekey, this.completesetkey, this.jobKey(jobid),
...
Manager.prototype.reconcile = function(callback) {
    ...
    async.parallel({
        ...
        activeSet: function(done) {
            removeInvalid('z', self.activequeuekey, done);
        },
